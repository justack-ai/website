...
function MatterPDF({
  ...
  return React.createElement(
    Document,
    { title: `CaseKeeper Export — ${matter.id}` },
    // Cover page
    React.createElement(
      Page,
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          "WARNING — LEGAL RECORD\n\n" +
            "This document is a production copy generated by CaseKeeper for Law Society of Ontario compliance purposes. " +
...
export async function POST(
  ...
  try {
    ...
    console.error("[CaseKeeper] PDF generation error:", pdfErr);
  ...
  return NextResponse.json({
    ...
    filename_stem: `casekeeper-${matter_id}-${Date.now()}`,
  });
}
