...
const sections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `A2Jai is committed to maintaining that duality by design. The open-source infrastructure is not a phase to be outgrown. It is a structural commitment — because the access-to-justice crisis will not be solved by any single company, and the tools to address it should not be locked behind a paywall. The commercial products sustain the enterprise; the open-source tools ensure that the mission outlives any business decision.`,
    ],
  },
  {
    label: "Author",
