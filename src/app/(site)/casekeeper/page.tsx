...
import type { MatterRow } from "@/lib/casekeeper/types";
...
export default async function CaseKeeperDashboard() {
    ...
    return (
      <main className="max-w-[800px] mx-auto px-6 md:px-8 py-20">
        <div className="mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-[-1.5px] mb-6">CaseKeeper</h1>
        ...
        <div className="glass p-8">
          ...
          <p className="text-sm font-light text-white/50 leading-relaxed mb-6">
            CaseKeeper captures client instructions in a structured, auditable format that creates a defensible record for your file. Built for lawyers who need to document what the client said, when they said it, and what was agreed.
          </p>
          <p className="text-sm font-light text-white/40">
            Interested? <Link href="/roadmap" className="text-purple-400 hover:text-purple-300 transition-colors">Join the roadmap waitlist</Link> to be notified when CaseKeeper launches.
          </p>
        </div>
      </main>
    );
    ...
    return (
      <main className="max-w-[800px] mx-auto px-6 md:px-8 py-20">
        ...
        <div className="glass p-8">
          ...
          <p className="text-sm font-light text-white/50 leading-relaxed mb-6">
            CaseKeeper is currently available by request. Sign in to access your matters, or contact us for access.
          </p>
          <Link
            href="/roadmap"
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 py-10">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">CaseKeeper</h1>
